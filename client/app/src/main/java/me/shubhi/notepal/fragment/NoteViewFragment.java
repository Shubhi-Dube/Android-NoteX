...
import me.shubhi.commons.helper.FragmentHelper;
...
import me.shubhi.commons.utils.ViewUtils;
import me.shubhi.commons.widget.Chip;
...
import me.shubhi.easymark.viewer.listener.LifecycleListener;
import me.shubhi.notepal.Constants;
import me.shubhi.notepal.PalmApp;
import me.shubhi.notepal.R;
import me.shubhi.notepal.databinding.FragmentNoteViewBinding;
import me.shubhi.notepal.dialog.OpenResolver;
...
import me.shubhi.notepal.util.ShortcutHelper;
import me.shubhi.notepal.vm.NoteViewerViewModel;
import me.shubhi.utils.stability.L;
import me.shubhi.utils.ui.ToastUtils;

import static me.shubhi.notepal.Constants.EXTENSION_3GP;
import static me.shubhi.notepal.Constants.EXTENSION_MP4;
import static me.shubhi.notepal.Constants.EXTENSION_PDF;
import static me.shubhi.notepal.Constants.MIME_TYPE_OF_PDF;
import static me.shubhi.notepal.Constants.MIME_TYPE_OF_VIDEO;
import static me.shubhi.notepal.Constants.URI_SCHEME_HTTP;
import static me.shubhi.notepal.Constants.URI_SCHEME_HTTPS;

/**
 * The fragment used to display the parsed the markdown text, based on the WebView.
 *
 * Created by WngShhng (shubhidube1308@gmail.com) on 2017/5/13.
 * Refactored by WngShhng (shubhidube1308@gmail.com) on 2018/11/30
 */
